...
author: "Christina Kochi, Oscar J. Ponce"
date: "06/12/2020"
...
```{r speech_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r comprehension_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r mood_analysis, fig.height = 3, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r social_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r qol_analysis, fig.height = 3, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
## Figure 1
```{r overall_mainoutcomes, fig.height = 11, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
overall1 <- rbind(
              tspeech1$b[1:3,],
...
plot <- plotmd_single_studies(words = overall1,
                      ...
                      lines = 
                        list('3' = gpar (lwd=1, columns=c(1:(ncol(tspeech1$b)+1)), col="black"),
                           ...
                           '15' = gpar (lwd=3, columns=c(1:(ncol(tspeech1$b)+1)), col="grey"),
...
<details><summary><b>Supplementary Figure 1: </b> Subgroup analysis for speech by stroke time </summary>

```{r subgroup_speech_stroketime, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 2:</b> Subgroup analysis for speech by musical experience </summary>

```{r subgroup_speech_musicalexp, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 3:</b> Subgroup analysis for speech by interventions based on rythm </summary>

```{r subgroup_speech_rythm, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 4:</b> Subgroup analysis for speech by interventions based in melodic intonation </summary>

```{r subgroup_speech_mit, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 5:</b> Subgroup analysis for comprehension by stroke time </summary>

```{r subgroup_comp_stroketime, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 6:</b> Subgroup analysis for comprehension by musical experience </summary>

```{r subgroup_comp_musicalexp, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 7:</b> Subgroup analysis for comprehension by interventions based on rythm </summary>

```{r subgroup_comp_rythm, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 8:</b> Subgroup analysis for comprehension by interventions based on melodic intonation </summary>

```{r subgroup_comp_mit, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 9:</b> Subgroup analysis for mood by stroke time </summary>

```{r subgroup_mood_musicalexp, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<details><summary><b>Supplementary Figure 10:</b> Subgroup analysis for mood by interventions based on rythm </summary>

```{r subgroup_mood_rythm, fig.height = 5.5, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r motorspeech_analysis,echo=FALSE, message=FALSE, warning=FALSE}
...
```{r naming_analysis,echo=FALSE, message=FALSE, warning=FALSE}
...
```{r repetition_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r spontaneous_speech_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r story_telling_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r reading_comprehension_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r auditory_comprehension_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r emotional_stability_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r energy_analysis, fig.height = 4, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r qol_mental_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r qol_physical_analysis, fig.height = 4, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r qol_perception_analysis, fig.height = 4, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r overall_surrogateoutcomes_part1, fig.height = 11, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
overall2 <- rbind(
              tnaming1$b[1:3,],
...
```{r overall_surrogateoutcomes_part2, fig.height = 11, fig.width = 16.5, echo=FALSE, message=FALSE, warning=FALSE}
overall3 <- rbind(
              taudComp1$b[1:3,],
...
<ul>
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Outcome: Speech </summary>
...
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Outcome: Comprehension </summary>
...
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Outcome: Mood  </summary>
...
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Outcome: Overall quality of life </summary>

```{r qol_sensitivity, fig.height = 2, fig.width = 14, echo=FALSE, message=FALSE, warning=FALSE}
...
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Surrogate outcome: Motor speech </summary>

```{r motorspeech_sensitivity, fig.height = 4, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Surrogate outcome: Naming </summary>

```{r naming_sensitivity, fig.height = 4, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Surrogate outcome: Repetition </summary>

```{r repetition_sensitivity, fig.height = 4, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
...
<li><details><summary><b>Supplementary Figure </b> - <em>Sensitivity analysis</em> Surrogate outcome: Reading comprehension </summary>

```{r reading_comprehension_sensitivity, fig.height = 4, fig.width = 16, echo=FALSE, message=FALSE, warning=FALSE}
